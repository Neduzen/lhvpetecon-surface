...
def CheckImageProgress(countryName, countryExportName, gridCells, yearFrom=1982, yearTo=2024, fails=30):
    folderpart = "-Image"
    creds = Initialize()
    service = build('drive', 'v3', credentials=creds)
    ...
    for cell in gridCells:
        for year in range(yearFrom, yearTo):
            ...
            allFiles.append(countryExportName + "-" + "image-" + str(cell[0]) + '-' + str(year) + ".tif")
