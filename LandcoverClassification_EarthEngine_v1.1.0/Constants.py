...
# USA
ASSETPATH_US = ASSET + "Landcover-USA/"
CLIMATESHAPE_US = ASSET + "climateShape-USA"

# EU
ASSETPATH_EU = ASSET + "Landcover/"
...
STATES_SHAPE_EENGINE = 'USDOS/LSIB_SIMPLE/2017'

# BRAZIL
ASSETPATH_BRAZIL = ASSET + "Landcover-Brazil/"
SHAPE_STATES_BRAZIL = ASSET + "brazil_states"